...
public class ListeforslagValghierarkiApplicationServiceTest extends MockUtilsTestCase {
	private ListeforslagValghierarkiApplicationService service;
	private ValghierarkiDomainService domainService;
	private UserData userData;

	@BeforeMethod
	public void setUp() throws Exception {
		service = initializeMocks(ListeforslagValghierarkiApplicationService.class);
