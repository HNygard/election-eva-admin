...
public class SuggestRejectVotingAuditEvent extends VotingsAuditEvent {

    private final VotingRejectionDto votingRejectionDto;
    private final Municipality municipality;

    public SuggestRejectVotingAuditEvent(UserData userData, List<VotingDto> votingDtoList, VotingRejectionDto votingRejectionDto, Municipality municipality,
    ...
    public String toJson() {
        ...
        builder.add("suggestedRejectionId", votingRejectionDto.getId());
