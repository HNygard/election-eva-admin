...
public class DeleteLevelingSeatSettlementAuditEvent extends AuditEvent {
	public DeleteLevelingSeatSettlementAuditEvent(UserData userData, AuditEventTypes auditEventType, Outcome outcome, String detail) {
