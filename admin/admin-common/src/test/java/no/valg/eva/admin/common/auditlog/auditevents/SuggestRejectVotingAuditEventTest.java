...
public class SuggestRejectVotingAuditEventTest {
    ...
    public void toJson_withNormalValues_isCorrect() {
        SuggestRejectVotingAuditEvent auditEvent = buildAuditEvent();
        ...
        with(auditEvent.toJson())
                ...
                .assertThat("$.votings[*].voterId", contains("VoterId"))
                .assertThat("$.votings[*].voterId", contains("VoterId"))
                .assertThat("$", hasEntry("suggestedRejectionId", "SuggestedRejectionId"))
                .assertThat("$", hasEntry("municipalityPk", 9));
    }

    private SuggestRejectVotingAuditEvent buildAuditEvent() {
        return new SuggestRejectVotingAuditEvent(objectMother.createUserData(), votingDtoList(), votingRejectionDto(), municipality(),
    ...
    public void objectClasses_mustReturnClassesOfObjectsDestinedForAuditEventConstructor() {
        assertThat(SuggestRejectVotingAuditEvent.objectClasses(AuditEventTypes.UpdateAll))
                .isEqualTo(new Class[]{List.class, VotingRejectionDto.class, Municipality.class});
    }
    ...
    public void testObjectClasses_givenInValidAuditEventTypes_verifiesException(AuditEventTypes auditEventType) {
        SuggestRejectVotingAuditEvent.objectClasses(auditEventType);
    }
