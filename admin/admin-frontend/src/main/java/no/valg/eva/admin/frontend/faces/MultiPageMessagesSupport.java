...
/**
 * Found at: http://ocpsoft.org/java/persist-and-pass-facesmessages-over-page-redirects/
 * 
...
public class MultiPageMessagesSupport implements PhaseListener {
	...
	private int restoreMessages(final FacesContext facesContext) {
		...
		for (Object element : messages) {
			FacesMessage msg = (FacesMessage) element;
			if (!contains(facesContext, msg)) {
	...
	private boolean contains(FacesContext ctx, FacesMessage msg) {
