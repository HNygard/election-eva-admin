...
public class ElectionCardConfigServiceProducer extends AbstractServiceProducer<ElectionCardConfigService> {

	@Produces
	public ElectionCardConfigService getService(final InjectionPoint ip) {
