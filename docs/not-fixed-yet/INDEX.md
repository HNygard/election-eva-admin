...
- `FIXED` **NF-009 — Frontend reaches the backend over remote EJB JNDI** — [NF-009-frontend-to-backend-ejb-lookups.md](NF-009-frontend-to-backend-ejb-lookups.md)
...
- `OPEN — 3 mappings now forced by evidence, 3 still assumed` **NF-015 — The security filter chain order cannot be recovered** — [NF-015-filter-chain-order-is-unrecoverable.md](NF-015-filter-chain-order-is-unrecoverable.md)
...
- `FIXED` **NF-030 — The EhCache configuration is missing** — [NF-030-ehcache-config-missing.md](NF-030-ehcache-config-missing.md)
