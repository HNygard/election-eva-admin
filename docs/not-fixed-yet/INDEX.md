...
- `OPEN` **NF-002 — Tests abort because EVOTE_PROPERTIES is not defined** — [NF-002-evote-properties-undefined-breaks-tests.md](NF-002-evote-properties-undefined-breaks-tests.md)
